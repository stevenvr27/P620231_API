...
{
    public partial class P620231_AutoApposvrContext : DbContext
    {
        public P620231_AutoApposvrContext()
        {
        }

        public P620231_AutoApposvrContext(DbContextOptions<P620231_AutoApposvrContext> options)
            : base(options)
        {
        }
