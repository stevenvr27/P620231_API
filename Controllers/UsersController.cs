...
namespace P620231_API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            //encriptar el password para validar contra el password encriptado en DB
        ...
        public ActionResult<IEnumerable<UserDTO>> GetUserData(string email)
        {
            ...
            //para asignar esos valor al DTO de usuario y entregarlos 
            //en formato json 
            ...
            foreach (var item in query)
            {
                UserDTO NewItem = new UserDTO()
                {
                    ...
                    RolDescripcion = item.roldescripcion,
                     ...
                     EstadoDescription = item.estadodesc
                };
